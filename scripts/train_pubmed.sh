...
# Input files:
solver_filename="${app_dir}/models/pubmed/solver.prototxt"
#model_filename="${app_dir}/models/nyt/model.prototxt"
model_filename="${app_dir}/models/pubmed/big_model.prototxt"
...
max_num_vertexes=8000
max_size_per_table=20
max_split_per_table=20
max_merge_per_table=8
num_table_id_bits=9

num_history=1

# Datset Parameters
train_data="${app_dir}/data/pubmed/docword.pubmed.txt.bin.trunc.txt.bin.shuffled.train"
test_data="${app_dir}/data/pubmed/docword.pubmed.txt.bin.trunc.txt.bin.shuffled.test.sub25"
mean="${app_dir}/data/pubmed/docword.pubmed.txt.bin.trunc.txt.bin.shuffled.train_mean.txt"
vocab="${app_dir}/data/pubmed/vocab.pubmed.txt.trunc"
vocab_size=70000
### #train = 7380000 / 6 / 16 = 76875 / 2 = 38438
### #train = 7380000 / 6 / 10 = 123000
### #train = 7380000 / 6 / 12 = 102500
### #train = 7380000 / 4 / 10 / 2 = 92250
### #train = 1845000 / 6 / 10 = 30750
### #train = 1845000 / 4 / 10 = 46125
