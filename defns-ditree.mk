# Requires PETUUM_BOSEN_ROOT to be defined

PETUUM_SRC = $(PETUUM_BOSEN_ROOT)/src
PETUUM_LIB = $(PETUUM_BOSEN_ROOT)/lib
PETUUM_THIRD_PARTY = $(PETUUM_BOSEN_ROOT)/third_party
